# NextGen Software WEB4 OASIS API Redis OASIS Provider

WEB4 OASIS API Redis OASIS Provider is one of the many WEB2/WEB3 providers that plug in and integrate into the OASIS.
